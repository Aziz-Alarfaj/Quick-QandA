...
<head>
    ...
    <title>Quick Q&amp;A Sign-up page</title>
            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    <form action="user-signup.php" method="POST">
                        ...
                        <!-- error messege if username or email is used -->
                        <?php
                            if(isset($_GET['error']))
                            {
                        ...
                        ?>
                                    <button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30" style="border-radius:5px">Sign up</button>
