...
<head>
    ...
    <title>Quick Q&amp;A Official website - Search</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                if ($_POST['search'] != '') {
                    //take value from search
                    $search_value = $_POST['search'];

                    $result = mysqli_query($con, "SELECT * FROM question WHERE question_title LIKE '%$search_value%' ORDER BY question_id DESC");
                    $user = mysqli_query($con, "SELECT user.username, user.user_id FROM user INNER JOIN question ON user.user_id = question.user_id WHERE question_title LIKE '%$search_value%' ORDER BY question_id DESC");

                    //check if no results are found
                    if (mysqli_num_rows($result) == 0) {
                        echo ("<h5 style='color:#909090'> Sorry, could not find any results for (&#34;$search_value&#34;) &#x1F644; &#x1F6B6; </h5>");
                    } else {
                        echo ("<h5 style='color:#909090'> Results for (&#34;$search_value&#34;) </h5>");
